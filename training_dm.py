...
CONFIGURATIONS = {
    ...
    LOGS_PATH: "results/logs/log_dm.txt",  # Directory to store log files
...
random.seed(7651962)  # Set a fixed seed for reproducibility
# 2) Random split seed
random_seed_split = random.randint(0, 9174937) # Random seed for splitting data into folds
# 3) Random seed torch
torch.manual_seed(775135) # Set seed for reproducibility in PyTorch
